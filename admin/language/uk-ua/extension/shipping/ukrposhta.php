...
$_['button_bonus_departure']				 = 'Бонусне відправлення';
$_['button_express']						 = 'Укрпошта Експрес';
$_['button_standard']						 = 'Укрпошта Стандарт';
$_['button_address_pick_up']				 = 'Адресний забір';
$_['button_department_delivery']			 = 'Доставка у відділення';
...
$_['column_longest_side']          	         = 'Найдовша сторона, см';
$_['column_department_service_cost']         = 'Обслуговування у відділенні, грн';
$_['column_doors_service_cost']              = 'Доплата за адресне обслуговування, грн';
$_['column_tariff_transfer_in_department']   = 'Передача у відділенні';
...
$_['column_shipment_group']				     = 'Група відправлення';
...
$_['column_last_modified_date']		         = 'Дата останньої зміни';
$_['column_sender']          			     = 'Відправник';
$_['column_sender_phone']          		     = 'Телефон відправника';
$_['column_sender_address']          		 = 'Адреса відправника';
$_['column_recipient']          			 = 'Одержувач';
$_['column_recipient_phone']          	     = 'Телефон одержувача';
...
$_['column_delivery_technology']         	 = 'Технологія доставки';
$_['column_description']         			 = 'Опис';
$_['column_delivery_payer']         		 = 'Платник доставки';
...
$_['entry_declared_cost_commission'] 		 = 'Комісія за оголошену вартість';
$_['entry_declared_cost_minimum_commission'] = 'Мінімальна комісія за оголошену вартість';
$_['entry_declared_cost_commission_bottom']  = 'Нижня межа комісії';
$_['entry_references']						 = 'Довідники';
$_['entry_region']              		     = 'Область';
$_['entry_city']              				 = 'Населений пункт';
$_['entry_department'] 						 = 'Відділення';
$_['entry_sender']              			 = 'Відправник';
$_['entry_recipient']          	   			 = 'Одержувач';
$_['entry_client_type']				         = 'Тип клиента';
$_['entry_tin']             			     = 'ІПН';
$_['entry_edrpou']             			     = 'ЄДРПОУ';
$_['entry_bank_account']             		 = 'Розрахунковий рахунок IBAN';
...
$_['entry_address_pick_up'] 				 = 'Адресний забір';
...
$_['entry_delivery_notification']            = 'Повідомлення про вручення';
$_['entry_sms_message']                      = 'СМС повідомлення';
$_['entry_check_on_delivery']                = 'Огляд при врученні';
$_['entry_on_fail_receive']                  = 'У разі невручення';
$_['entry_use_parameters']					 = 'Застосування параметрів';
$_['entry_weight'] 							 = 'Вага';
$_['entry_dimensions'] 						 = 'Розміри (Д х Ш x В)';
$_['entry_allowance'] 					     = 'Допуск (Д х Ш x В)';
...
$_['entry_bonus_departure']                  = 'Бонусне відправлення';
$_['entry_displayed_information']            = 'Інформація для відображення';
$_['entry_print_type']                       = 'Тип документу';
$_['entry_print_format']                     = 'Формат друку';
$_['entry_print_sender_name']                = 'Друк імені контрагента';
$_['entry_print_delivery_price']             = 'Друк вартості доставки';
$_['entry_print_declared_price']             = 'Друк оголошеної вартості';
...
$_['entry_shipment_group'] 				     = 'Група відправлення';
...
$_['help_ecom_bearer'] 			             = 'Вкажіть код доступу для eCom. Інформацію про його отримання можна знайти на сайті компанії «Укрпошта»';
$_['help_tracking_bearer'] 			         = 'Вкажіть код доступу для StatusTracking. Інформацію про його отримання можна знайти на сайті компанії «Укрпошта»';
$_['help_user_token'] 			             = 'Вкажіть токен користувача. Інформацію про його отримання можна знайти на сайті компанії «Укрпошта»';
...
$_['help_declared_cost_commission'] 		 = 'Вкажіть комісію від повної суми оголошеної вартості за оцінку відправлення';
$_['help_declared_cost_minimum_commission']  = 'Вкажіть мінімальну комісію за оголошену вартість';
$_['help_declared_cost_commission_bottom']   = 'Вкажіть мінімальну оголошену вартість відправлення, більше якої буде розраховуватися додаткова комісія';
...
$_['help_update_cities'] 					 = 'Буде виконано оновлення населених пунктів поштової компанії';
$_['help_update_departments']				 = 'Буде виконано оновлення відділень поштової компанії';
$_['help_sender'] 							 = 'Вкажіть назву або П.І.Б відправника';
$_['help_sender_client_type']				 = 'Оберіть тип клієнта для відправника';
$_['help_sender_tin']             			 = 'Вкажіть індивідуальний податковий номер відправника';
$_['help_sender_edrpou']             		 = 'Вкажіть код ЄДРПОУ юридичної особи';
$_['help_sender_bank_account']             	 = 'Вкажіть розрахунковий рахунок відправника в міжнародному форматі IBAN (29 символів)';
$_['help_sender_email']             		 = 'Вкажіть e-mail відправника';
$_['help_sender_phone']              		 = 'Вкажіть телефон відправника (тільки цифри)';
$_['help_sender_region']              		 = 'Вкажіть область відправника';
$_['help_sender_city']       	       		 = 'Вкажіть місто відправника';
$_['help_sender_street']              		 = 'Вкажіть вулицю відправника';
$_['help_sender_house']              		 = 'Вкажіть будинок відправника';
$_['help_sender_flat']              		 = 'Вкажіть квартиру відправника';
$_['help_sender_postcode'] 					 = 'Вкажіть поштовий індекс відправника';
$_['help_address_pick_up'] 				     = 'Чи потрібен забір посилки кур`єром?';
$_['help_recipient'] 						 = 'Вкажіть макрос для отримувача. Приклад: {shipping_lastname} {shipping_firstname}';
$_['help_recipient_client_type']			 = 'Вкажіть макрос або тип клієнта для отримувача за замовчуванням (INDIVIDUAL, COMPANY, PRIVATE_ENTREPRENEUR). Приклад макросу: {shipping_recipient_type}';
$_['help_recipient_tin']             		 = 'Вкажіть макрос для індивідуального податкового номера відправника. Приклад: {shipping_tin}';
$_['help_recipient_edrpou']             	 = 'Вкажіть макрос для коду ЄДРПОУ отримувача. Приклад: {shipping_company}';
$_['help_recipient_phone']	                 = 'Вкажіть макрос для номеру телефону отримувача. Приклад: {telephone}';
...
$_['help_recipient_department'] 		   	 = 'Вкажіть макрос для відділення та/або поштомату отримувача. Приклад: {shipping_address_1}';
...
$_['help_recipient_postcode'] 				 = 'Вкажіть макрос для поштового індексу отримувача. Приклад: {shipping_postcode}';
...
$_['help_departure_description']             = 'Використовується як шаблон для поля опису відправлення при створенні ТТН. Можливе застосування макросів. При використанні макросів товару розділяйте текст на два блоки за допомогою символу «|» (макроси товару використовуйте в другому блоці)';
$_['help_delivery_notification']             = 'Відправлення з повідомленням про вручення. При отриманні відправлення відправник отримує лист про те, що відправлення було отримано';
$_['help_sms_message']                       = 'Відправляти sms-повідомлення про прибуття посилки клієнту?';
$_['help_check_on_delivery']                 = 'Дозволити огляд посилки при отриманні?';
$_['help_on_fail_receive']                   = 'Дії з відправленням у випадку, якщо одержувач не забрав його';
...
$_['help_bonus_departure']                   = 'Створення бонусного відправлення за програмою лояльності';
$_['help_displayed_information']             = 'Оберіть інформацію для відображення';
$_['help_print_type']                        = 'Вкажіть тип документу для друку за замовчуванням';
$_['help_print_format']                      = 'Вкажіть формат друку';
$_['help_print_sender_name']                 = 'Відображати ім`я контрагента в друкованій формі?';
$_['help_print_delivery_price']              = 'Відображати вартість відправлення в друкованій формі?';
$_['help_print_declared_price']              = 'Відображати оголошену вартість в друкованій формі?';
...
$_['text_verification_ecom_bearer']          = 'Перевірка eCom Bearer';
$_['text_verification_tracking_bearer']      = 'Перевірка StatusTracking Bearer';
$_['text_verification_user_token']           = 'Перевірка User Token';
$_['text_references_updating']				 = 'Оновлення довідкової інформації';
$_['text_regions_updating']					 = 'Оновлення областей';
$_['text_cities_updating']					 = 'Оновлення населених пунктів';
$_['text_departments_updating']				 = 'Оновлення відділень';
$_['text_saving_settings']                   = 'Збереження налаштуваннь';
$_['text_express_department']				 = 'Експрес у відділення';
$_['text_express_doors']					 = 'Експрес кур`єром';
$_['text_standard_department']				 = 'Стандарт у відділення';
$_['text_standard_doors']					 = 'Стандарт кур`єром';
...
$_['text_express_tariffs'] 				     = 'Тарифи Укрпошта Експрес';
$_['text_standard_tariffs'] 				 = 'Тарифи Укрпошта Стандарт';
$_['text_update_success']	 				 = 'Дані успішно оновлено';
$_['text_help_sender_save'] 				 = 'Після внесення змін необхідно обов`язково зберегти дані клієнта натисканням на кнопку «Зберегти» в полі «Відправник»';
$_['text_help_sender_search'] 				 = 'Щоб завантажити дані існуючого відправника досить ввести його номер телефону у відповідне поле та натиснути кнопку пошуку';
$_['text_client_saved_successfully'] 		 = 'Клієнт успішно збережений';
$_['text_client_data_found'] 		         = 'Дані клієнта знайдені';
...
$_['text_products_without_parameters'] 		 = 'До товарів без параметрів';
$_['text_all_products'] 					 = 'До кожного товару';
$_['text_whole_order'] 						 = 'До всього замовлення';
$_['text_on_department']                     = 'У відділенні';
$_['text_to_bank_account']                   = 'На розрахунковий рахунок';
$_['text_consignment_note_creating']		 = 'Створення накладної';
...
$_['text_help_cron'] 						 = 'Задайте ключ і збережіть налаштування модулю, далі скопіюйте необхідну команду та додайте її в завдання Cron у Вашій панелі управління хостингом. Оптимальна частота запуску:<br/>
	<ul>
		<li>населені пункти та відділення - 1 раз на добу</li>
...
$_['text_cn_template_macros'] 				 = '<strong>Макроси ТТН:</strong><br/>
	<code>{barcode}</code> - бар-код відправлення<br/>
	<code>{step}</code> - порядковий номер події<br/>
	<code>{date}</code> - дата та час останнього статусу відправлення<br/>
	<code>{index}</code> - індекс поштового відділення<br/>
	<code>{name}</code> - назва поштового відділення<br/>
	<code>{event}</code> - код події процесу обробки<br/>
	<code>{eventName}</code> - розшифровка коду події<br/>
	<code>{country}</code> - країна знаходження відправлення<br/>
	<code>{eventReason}</code> - уточнююча інформація щодо події<br/>
	<code>{eventReason_id}</code> - сервісна інформація<br/>
	<code>{mailType}</code> - тип поштового відправлення<br/>
	<code>{indexOrder}</code> - сервісна інформація';
$_['text_macros']                            = 'Макроси';
$_['text_add']						         = 'Додати';
$_['text_add_to_group']						 = 'Додати в групу';
$_['text_delete_from_group']				 = 'Видалити з групи';
$_['text_success_added_to_group']			 = 'Накладна успішно додана в групу';
$_['text_success_deleted_from_group']		 = 'Накладна успішно видалена з групи';
...
$_['text_address_sticker_100x100']			 = 'Адресний ярлик 100x100';
$_['text_address_sticker_group_100x100']     = 'Адресний ярлик для групи 100x100';
$_['text_group_form_103a']                   = 'Форма 103а для групи';
$_['text_a4']						         = 'А4';
$_['text_a5']						         = 'А5';
...
$_['error_verification'] 					 = 'Помилка перевірки!';
$_['error_update']							 = 'Помилка оновлення даних!';
$_['error_client_save']						 = 'Помилка збереження клієнта!';
$_['error_client_search']					 = 'Помилка пошуку клієнта!';
...
$_['error_added_to_group']			         = 'Не вдалося додати накладну в групу!';
$_['error_deleted_from_group']		         = 'Не вдалося видалити накладну з групи!';
$_['error_tin'] 							 = 'ІПН повинен складатися з 10 або 12 цифр!';
$_['error_edrpou'] 							 = 'ЄДРПОУ повинен складатися з 5-8 цифр!';
$_['error_bank_account'] 					 = 'Розрахунковий рахунок повинен складатися з 29 символів!';
$_['error_phone'] 							 = 'Невірний формат номера телефону! Приклад: 380501234567 або 0931234567';
$_['error_postcode'] 					     = 'Поштовий індекс повинен складатися з 5 цифр!';
$_['error_weight'] 							 = 'Вага має бути дробовим або цілим числом більше 0, але не більше 30 000! Коректні приклади: 7, 1.002';
$_['error_width']              				 = 'Ширина має бути цілим числом!';
$_['error_length']              			 = 'Довжина має бути цілим числом не більше 200 см!';
$_['error_height']             		 		 = 'Висота має бути цілим числом!';
$_['error_sum'] 				             = 'Сума має бути дробовим або цілим числом більше 0! Коректні приклади: 700, 100.5';
$_['error_departure_description']            = 'Додаткова інформація про відправлення не може бути більше 40 символів!';